...
class OrderByPriceDescending : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_order_by_price_descending)
        getMyData()
    ...
    private fun getMyData() {
        val response = RetroBuilder.retrofit.getAllBookOrderByPriceDescending()
        ...
        response.enqueue(object : Callback<List<BookItem>> {
            override fun onResponse(
                ...
                recyclerView.layoutManager = GridLayoutManager(this@OrderByPriceDescending, 2)
            ...
            override fun onFailure(call: Call<List<BookItem>?>, t: Throwable) {
                Toast.makeText(this@OrderByPriceDescending,
